...
from .dance_helpers import (
    validate_doi, extract_doi_parts, extract_pma_metadata, 
    PublisherURLBuilder, handle_dance_exceptions
)
...
def the_frontiers_square(pma, verify=False):
    ...
    # Build URLs using the helper
    builder = PublisherURLBuilder('frontiersin.org', 'Frontiers')
    
    # Add DOI-based patterns
    builder.add_doi_patterns([
        'articles/{doi}/full',
        'articles/{doi}/pdf', 
        'article/{doi}/pdf',
        'journals/article/{doi}',
        'journals/{doi}'
    ], pma.doi)
    
    # Add patterns for alternative domains
    builder.add_custom_urls([
    ...
    # Custom paywall indicators for Frontiers (minimal since mostly open access)
    ...
    return builder.verify_or_return_first(verify, frontiers_paywall_indicators)

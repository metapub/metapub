...
wiley_journals = [
        ...
        'Brain Pathol',
        'Breast J',
        'Brown Univ Dig Addict Theory Appl',
        ...
        'Concurr Comput',
        'Conf Proc Ethnogr Prax Ind Conf',
        'Congenit Anom (Kyoto)',
        'Congenit Heart Dis',
        'Congest Heart Fail',
        'Conserv Biol',
        ...
        # Hindawi journals (acquired by Wiley, use same DOI template)
        # DOI pattern: 10.1155/YYYY/ARTICLEID
        'AIDS Res Treat',
        'Adv Acoust Vib',
        'Adv Bioinformatics',
        'Adv Biol',
